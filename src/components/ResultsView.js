...
<Modal
  ...
  footer={[
    <Space key="footer" style={{ justifyContent: "center", width: "100%" }}>
      <Button
        key="toggle"
        type="default"
        ...
        {[
          ...
          <Col xs={24} sm={12} md={6} key={i}>
            ...
            >
              ...
              />
              <Text style={{ color: "#333", fontSize: 15 }}>{info.value}</Text>
            </Card>
          </Col>
        ))}
      </Row>
...
<Modal
  ...
  footer={[
    <Space key="controls" style={{ justifyContent: "center", width: "100%" }}>
      {pausedRef.current ? (
        <Button
...
>
  ...
  <div style={{ marginBottom: 24 }}>
    <Progress
      ...
      trailColor="#f0f0f0"
      status={
        progress < 100 ? "active" : failCount > 0 ? "exception" : "success"
      }
      style={{
